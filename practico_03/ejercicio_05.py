...
class MonteCarlo:
    ...
    def monte_carlo_n_vars_a_b(self, g, a: list, b: list, n_vars, n_sim):
        """
        Aproximacion de la integral de la funcion g (de n variables) sobre los intervalos dados por a, b.
        Aclaracion:
...
if __name__ == "__main__":
    ...
    for n in [100, 1_000, 10_000, 100_000, 1_000_000]:
        ...
        print(f"n: {n:<10} aproximacion: {aprox:<10}")
    print("Resultado exacto: 4.89916")

    print("\n============ f ============")
    for n in [100, 1_000, 10_000, 100_000, 1_000_000]:
        aprox = mc.monte_carlo_n_vars_0_inf(g=func_f, n_vars=2, n_sim=n)
        print(f"n: {n:<10} aproximacion: {aprox:<10}")
    print("Resultado exacto: 0.5")
